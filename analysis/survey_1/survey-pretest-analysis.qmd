...
# if downloading from osf:
 ...
 # raw_dfs_tibbles <- map(osf_csv_filenames_filtered, ~read_csv(file.path("data/", .)))
 # rawwwwwww_df <- bind_rows(raw_dfs_tibbles)

# when manually downloading data instead of using osf retrieval:
...
In sum, we plan to add five new items to our questionnaire: "I would feel like the topic is too complex or requires more knowledge than I have," "I don't have first-hand experience with the topic and/or it isn't relevant to me," "I could experience significant repercussions at work or in other spaces beyond my personal social network," "It wouldn't be worth the emotional and/or mental energy," and "I would not want to hurt my relationship(s) with others or upset them."
