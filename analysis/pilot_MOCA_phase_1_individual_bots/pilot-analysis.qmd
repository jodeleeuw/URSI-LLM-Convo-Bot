...
osf_retrieve_node("x32pv") %>%
   ...
   osf_download(path = "data_early", conflicts = "skip")
...
osf_csv_filenames <- list.files(path = "data_early/")
raw_dfs_tibbles <- map(osf_csv_filenames, ~read_csv(file.path("data_early/", .)))
...
good_data_prolific_demographics_df <- bind_rows(demo1, demo2) 
