...
Americans are increasingly unwilling to engage in conversations about emotionally charged or politically divisive topics—discussions that are essential for fostering empathy, intellectual humility, and democratic resilience (@finkel2020; @iyengar2019). While cross-group human-to-human conversations can lead to increased open-mindedness and reduce polarization (e.g., @broockman2016; @combs2023; @elnakouri2024; @fernbach2013), the magnitude and longevity of these effects are disputed (e.g., @santoro2022). Additionally, these conversations can become unproductive and inaccessible (@bishop2008; @chen2018), exacerbating polarization, existing biases, and avoidance of future cross-group interactions (@paolini2010; @shelton2009; @trawalter2009). Intergroup contact theory suggests, however, that enduring these short-term costs and participating in longer or more frequent cross-group interactions can lead to lowered anxiety and prejudice, in turn leading to increased cross-group contact (@macinnis2015, @binder2009; @blascovich2001 @pettigrewandtrop2006; @islam1993; @pagegould2008; @paolini2004; @paolini2006; @voci2003). This presents a societal challenge: how can we foster greater willingness in Americans to engage with each other across ideological divides?
