var jsPsychVslAnimateOcclusion = (function (jspsych) {
	'use strict';
	...
	function requireEve () {
		if (hasRequiredEve) return eve$1.exports;
		hasRequiredEve = 1;
		(function (module) {
	...
	var snap_svgExports = snap_svg.exports;
	var Snap = /*@__PURE__*/getDefaultExportFromCjs(snap_svgExports);
	...
	return VslAnimateOcclusionPlugin;
