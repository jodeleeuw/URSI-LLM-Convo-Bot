...
In an era of rising polarization in America, fostering the ability for productive, non-threatening conversations on disputed topics could facilitate better mutual understanding. Existing research on human-to-human conversations has suggested ways conversations can become more productive (Combs et al., 2023 & Elnakouri et al., 2024), and existing research on LLMs has suggested that chatbots can influence human views (Costello et al., 2024). By surveying participants before and after they spoke with our specialized chatbot, we found that [results].
...
Previous research indicates that AI chatbots can be persuasive in changing people’s opinions on highly disputed topics (Altay et al., 2022; Andrews et al., 2008; Chalaguine et al., 2019; Costello et al., 2024) and increasing their open-mindedness (Elnakouri et al., 2024). The present pilot study will leverage these insights to explore conversational LLMs as tools for increasing willingness to converse about highly disputed topics.

We worked with six divisive topics in the U.S.: human euthanasia, the role of the government in healthcare, same-sex marriage, mandating vaccines, the criminal justice system, and gender equality. We also worked with the topic of atomic bombings during our initial pilot phases, but eventually excluded the topic because data indicated that subjects did not feel as strongly about it as we had anticipated.

“Psychologists define ‘‘open-mind’’ thinking as the willingness to consider alternative perspectives, evaluate contradictory evidence, and be flexible rather than dogmatic (Stanovich, 1999, p190-191)” (https://doi.org/10.1016/j.socec.2023.102152).

Several research findings suggest that political discussions can easily turn toxic, fueling, rather than curbing, intergroup hostility (Brady, Wills, Jost, Tucker, & Van Bavel, 2017; Chen & Rohla, 2018; Finkel et al., 2020; Hutchens, Hmielowski, & Beam, 2019; Hwang, Kim, & Kim, 2018; Mendelberg & Oleske, 2000; Santoro & Broockman, 2021), in part because political discussions are often motivated by a desire to signal one’s political identity rather than arrive at the truth (Kahan & Braman, 2006; Van Bavel & Pereira, 2018; Van Bavel, Sternisko, Harris, & Robertson, 2020). Thus, while cross-partisan discussions serve as an opportunity for an open-minded exchange, these discussions more often end up as arenas where people advertise their political stripes, especially when facing off with someone they disagree with (Walsh, 2010). Cognitive scientists have found that inviting people to explain (rather than freely reflect on) the contentious political issues may help reduce intergroup toxicity in these discussions (Fernbach, Rogers, Fox, & Sloman, 2013).

Confronted with their lack of understanding, people might then become more moderate as well as forgiving towards those they disagree with on the issue. Indeed, Fernbach et al. (2013) observed that invitations to explain (vs. freely reflect on) a policy position resulted in more moderate policy convictions and lower hostility towards political outgroup members. However, subsequent scholarship either found no evidence for the effect (Crawford & Ruscio, 2021) or found it to be constrained to specific topics (Sloman & Vives, 2022) or personalities (Voelkel, Brandt, & Colombo, 2018). That is, inviting people to explain specific policy positions did not consistently lead to less extreme policy positions, nor did it influence how they felt about political partisans

Another possibility is that explanations might still hold some promise, changing the process of how people think rather than the content of what people believe. Specifically, inviting people to explain themselves could encourage information search via consulting others’ viewpoints and integration of multiple perspectives, opening the door for wiser, more open-minded political thinking (Baron, 2019; Grossmann et al., 2021; Grossmann & Kross, 2014; Kross & Ayduk, 2017; Stanovich & West, 1997; see Grossmann et al., 2021, Porter et al., 2022, for reviews)

Papers like Altays, Chalaguine, Andrews, use variations of argumentation, i.e argument type, argument selection, phrasing, etc., and in an attempt to overcome the inability of domain general interaction of GOFAI bots, to create algorithms of argumentative response between bot and user. These, with the specificity of their strategy, focus more on the actual content of argument rather than the ‘vibes’ from the bot, i.e the extent to which it can mimic human behavior/demeanor. Because of the limitation of earlier bots, the long line of argumentative strategy from the psychology domain, which focuses mostly on emotional appeal, in-group creation, etc. had yet a chance to shine in the creation of AI bots. With GPT, however, perhaps there is the chance. Yet, due to controversy of tricking participants into believing the AI is human, we have decided to avoid that strategy. Now that AI can mimic real humans, and the literature of human-human persuasion from psychology could actually be applied, practical concerns still prevent its ethical use, a topic to be considered for the future of AI persuasion.
...
We used custom software written with the jsPsych framework (de Leeuw et al., 2023), which participants viewed and responded to via their personal laptops or desktops. The javascript code for the experiment and data analysis can be found at (https://github.com/jodeleeuw/URSI-LLM-Convo-Bot/tree/main/pilot_1). Pre-registration and all data for this study and previous pilots are available at https://osf.io/x32pv.

#### Intervention development

There are findings from human-to-human research on approaches, techniques, and situational factors that can make people more willing to have conversations on controversial topics and be more productive/open-minded. Though the findings were abundant and there were thus a myriad of approaches which we could have taken, we extracted three general approaches: providing counterarguments, asking questions about the user's views, and explaining why others might have alternative perspectives. \[cite the research for each one\].
...
We conducted our analyses in the R environment (R version 4.2.1; R Core Team, 2022), using several packages from the tidyverse (Wickham et al., 2019), as well as the osfr (Wolen et al., 2020), ez (Lawrence, 2016), gt, gtsummary, kableExtra, stringr, and ggridges packages.

library(osfr) library(ez) library(tidyverse) library(gt) library(gtsummary) library(kableExtra) library(stringr) library(ggridges)
